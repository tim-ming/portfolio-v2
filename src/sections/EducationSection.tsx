          ...
          <li key={item.degree} className="flex flex-col gap-6 text-base text-gray-300">
            <div>
              ...
              <a
                ...
                className="focus-outline group flex w-fit items-center gap-1 rounded-md text-gray-400"
              >
                <span className="animated-text font-medium"> {`${item.institution} · ${item.location}`}</span>
